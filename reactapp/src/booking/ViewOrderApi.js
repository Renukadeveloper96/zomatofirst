...
const url="https://zomatojulyapi.herokuapp.com/viewOrder";
const url1 = "https://zomatojulyapi.herokuapp.com/updateOrder"
    ...
    render(){
        ...
        return(
            <div className="container">
                ...
                <h2 > SUCCESSFULLY UPDATED ORDERS!!! </h2>
                <h2 > You Can See Updated Orders Click on <span className="orders ordersbg">above Link</span> </h2>
            </div>
        )
    }
